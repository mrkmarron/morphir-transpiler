...
exports.enqueueICPPTest = void 0;
function enqueueICPPTest(testsrc, jargs, expected, cb) {
    const start = new Date();
    const end = new Date();
    cb("fail", start, end, "Disabled");
}
exports.enqueueICPPTest = enqueueICPPTest;
//# sourceMappingURL=icpp_runner.js.map